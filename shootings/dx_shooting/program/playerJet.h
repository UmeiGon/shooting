...
public:
	...
	enum teisu { OVERHEAT_SEC = 3, MAX_ARM_SUU = 3, MAX_SHOT_TYPE = 4 ,MAX_KOKI_SUU=4,MAX_RUNE_SUU=30,SET_RUNE_SUU=5};
	...
	float runePower(int type);
	Rune* runes[MAX_RUNE_SUU];
	Rune* setRunes[SET_RUNE_SUU];
	shotd* shotData[MAX_ARM_SUU][MAX_SHOT_TYPE];
	Bullet* koki[MAX_KOKI_SUU];
	shotd* shotDataSet(armtype atype, pShotType shotN);
