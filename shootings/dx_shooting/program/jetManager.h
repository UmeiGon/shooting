...
public:
	...
	enum teisu {MAX_ANIM_SUU=50,MAX_ENEMY_SUU = 10,MAX_SHOT_SUU = 100,MAX_TARGET_SUU=100,MAX_GFX_SUU=20,MAX_ARM_GFX_SUU=3,MAX_SHOT_GFX_SUU=10,MAX_UI=8};//最大数などの定数を入れる
